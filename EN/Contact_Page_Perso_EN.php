...
<?php
	...
	if (isset($_POST['envoi'])) {
		...
		if ($flag_erreur == 0) {	
			...
			$email_dest = "Sadek.ALHARBAT@gmail.com,SadekALHARBAT@yahoo.com," . $_SESSION['zone_email1'];
			$sujet = $_SESSION['champ2'];
			$entetes ="MIME-Version: 1.0 \n";
			$entetes .="From:" . $_SESSION['zone_email1'] . "\n";
			$entetes .="Return-Path: ...<Sadek.ALHARBAT@gmail.com,SadekALHARBAT@yahoo.com>\n";
			...
			if (@!mail($email_dest,$sujet,$sortie,$entetes)) {
				...
				echo('<meta http-equiv="refresh" content="0; URL=https://dl.dropboxusercontent.com/u/7437808/Page_Perso_Sadek/EN/Thanks_Page_Perso.html">');	
                exit();
            } // Fin else
